...
return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'App\\DataFixtures\\SuperAdminFixetures' => ['privates', 'App\\DataFixtures\\SuperAdminFixetures', 'getSuperAdminFixeturesService.php', true],
    ...
    'App\\Form\\UserPrestataireType' => ['privates', 'App\\Form\\UserPrestataireType', 'getUserPrestataireTypeService.php', true],
    ...
    'argument_resolver.controller_locator' => ['privates', '.service_locator.w.X_Vxy', 'get_ServiceLocator_W_XVxyService.php', true],
    ...
    'nelmio_api_doc.controller_reflector' => ['privates', 'nelmio_api_doc.controller_reflector', 'getNelmioApiDoc_ControllerReflectorService.php', true],
    'nelmio_api_doc.describers.api_platform' => ['privates', 'nelmio_api_doc.describers.api_platform', 'getNelmioApiDoc_Describers_ApiPlatformService.php', true],
    'nelmio_api_doc.describers.api_platform.documentation' => ['privates', 'nelmio_api_doc.describers.api_platform.documentation', 'getNelmioApiDoc_Describers_ApiPlatform_DocumentationService.php', true],
    'nelmio_api_doc.describers.config' => ['privates', 'nelmio_api_doc.describers.config', 'getNelmioApiDoc_Describers_ConfigService.php', true],
    'nelmio_api_doc.describers.config.default' => ['privates', 'nelmio_api_doc.describers.config.default', 'getNelmioApiDoc_Describers_Config_DefaultService.php', true],
    'nelmio_api_doc.describers.default' => ['privates', 'nelmio_api_doc.describers.default', 'getNelmioApiDoc_Describers_DefaultService.php', true],
    'nelmio_api_doc.describers.route.default' => ['privates', 'nelmio_api_doc.describers.route.default', 'getNelmioApiDoc_Describers_Route_DefaultService.php', true],
    'nelmio_api_doc.describers.swagger_php.default' => ['privates', 'nelmio_api_doc.describers.swagger_php.default', 'getNelmioApiDoc_Describers_SwaggerPhp_DefaultService.php', true],
    'nelmio_api_doc.form.documentation_extension' => ['privates', 'nelmio_api_doc.form.documentation_extension', 'getNelmioApiDoc_Form_DocumentationExtensionService.php', true],
    'nelmio_api_doc.generator_locator' => ['privates', 'nelmio_api_doc.generator_locator', 'getNelmioApiDoc_GeneratorLocatorService.php', true],
    'nelmio_api_doc.model_describers.form' => ['privates', 'nelmio_api_doc.model_describers.form', 'getNelmioApiDoc_ModelDescribers_FormService.php', true],
    'nelmio_api_doc.model_describers.object' => ['privates', 'nelmio_api_doc.model_describers.object', 'getNelmioApiDoc_ModelDescribers_ObjectService.php', true],
    'nelmio_api_doc.route_describers.fos_rest' => ['privates', 'nelmio_api_doc.route_describers.fos_rest', 'getNelmioApiDoc_RouteDescribers_FosRestService.php', true],
    'nelmio_api_doc.route_describers.php_doc' => ['privates', 'nelmio_api_doc.route_describers.php_doc', 'getNelmioApiDoc_RouteDescribers_PhpDocService.php', true],
    'nelmio_api_doc.route_describers.route_metadata' => ['privates', 'nelmio_api_doc.route_describers.route_metadata', 'getNelmioApiDoc_RouteDescribers_RouteMetadataService.php', true],
    'nelmio_api_doc.routes.default' => ['privates', 'nelmio_api_doc.routes.default', 'getNelmioApiDoc_Routes_DefaultService.php', true],
    ...
    'App\\DataFixtures\\SuperAdminFixetures' => '?',
    'App\\Form\\CaissierType' => '?',
    'App\\Form\\Depot1Type' => '?',
    'App\\Form\\DepotType' => '?',
    'App\\Form\\UserPrestataireType' => '?',
