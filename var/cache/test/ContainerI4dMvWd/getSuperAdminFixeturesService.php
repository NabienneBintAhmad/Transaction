...
// Returns the private 'App\DataFixtures\SuperAdminFixetures' shared autowired service.
...
include_once $this->targetDirs[3].'/src/DataFixtures/SuperAdminFixetures.php';

return $this->privates['App\\DataFixtures\\SuperAdminFixetures'] = new \App\DataFixtures\SuperAdminFixetures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
